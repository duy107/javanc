...
public class AuthenticationController {
    ...
    public ResponseEntity<?> setProfile(@RequestBody InformationUserUpdateRequest informationUserUpdateRequest){
        ...
        List<UserAddressEntity> userAddressEntities = informationUserUpdateRequest.getAddressRequestList()
                .stream()
                .map(req -> {
                    AddressEntity addressEntity;
                    if (req.getAddressId() != null) {
                        addressEntity = addressRepository.findById(req.getAddressId())
                                .orElseThrow(() -> new AppException(ErrorCode.USER_ADDRESS_NOT_FOUND)); // xử lý đúng
                    ...
                    if (req.getUserAddressId() != null) {
                        userAddressEntity = userAddressRepository.findById(req.getUserAddressId())
...
for(UserAddressEntity ua : userAddressEntities) {
    ...
    InformationUserUpdateResponse.AddressUpdateDTO dto = InformationUserUpdateResponse.AddressUpdateDTO.builder()
            .userAddressId(ua.getId())
    ...
    addressUpdateDTOS.add(dto);
        ...
        InformationUserUpdateResponse informationUserUpdateResponse = InformationUserUpdateResponse.builder()
                .avatar(user.getAvatar())
                .name(user.getName())
                .phone(user.getPhone())
                .email(user.getEmail())
                .addressUpdateDTOs(addressUpdateDTOS)
        ...
        return ResponseEntity.ok().body(
                ApiResponseDTO.<InformationUserUpdateResponse>builder()
                .message("Oke")
                .result(informationUserUpdateResponse)
                .build()
        );
    }
